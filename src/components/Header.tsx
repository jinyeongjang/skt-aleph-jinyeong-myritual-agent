...
const NAV_ITEMS: NavItem[] = [
  { href: '#ritual-agent', label: '나를 말하는 리추얼 에이전트', desc: '리추얼 기록 & 강점 지도 & 서사' },
...
export const Header: React.FC<HeaderProps> = ({ className }) => {
  ...
  const [activeSection, setActiveSection] = useState<string>('#ritual-agent');
